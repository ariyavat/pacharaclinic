...
export default class HometypMobil extends React.Component {
  constructor(props){
    super(props);
      this.items = [
  ...
  render () {
    ...
    <section  >	   
	    ...
	    <div className="container">
            <div className="row">
                <div className='col text-center mgt-10'>
                <h5>บริการของ PACHARA CLINIC</h5>
                </div>
            </div>
