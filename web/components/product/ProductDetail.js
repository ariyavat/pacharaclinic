...

	  	{
		    ...
		    <div className="col-md-12" >
				...
				<div className="row">
				    ...
				    <div className="col-md-6" >
						<h3 className="txt-green font-01">{data.product_name}  <small>{data.wg}ml</small></h3>
						<div className="row">
						...
						<div className="row">
						    <div className="col-md-12" >
							<ShopBox data={data} qty={item.qty} mode='P' typ='D' img={img}  onUpdate={this.onUpdate.bind(this)} />	
						    </div>
						</div>
