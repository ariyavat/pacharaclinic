...
export default class Calendar extends React.Component {
  ...
  hadleSelect(date,dname){    
    const { currentMonth, currentYear } = this.state
    let sn = parseFloat(currentMonth) + 1
    ...
    let rt = moment().isSameOrBefore(tdat);




    let cm =moment().startOf('month').format("MM");
    let cy = moment().endOf("year").format("YYYY");
    ...
    let i = 0;
      ...
      const row1 = array.map((item,j)=>{
        ...
        return (<td key={item+j} height="80"></td>)         
          ...
          return( 
          <td key={item+j} className={cls} onClick={this.hadleSelect.bind(this,date,dname)}> 
            {date}
      ...
      const row2 = array.map((item,j)=>{
        ...
        return (<td key={item+j} height="80"></td>)         
          ...
          return( 
          <td height="80" key={item+j} className={cls} onClick={this.hadleSelect.bind(this,date,dname)}>
            {date}
            <div>
      ...
      const row3 = array.map((item,j)=>{
        ...
        return (<td key={item+j}></td>)         
          ...
          return( <td height="80" key={item+j} className={cls} onClick={this.hadleSelect.bind(this,date,dname)}>
          {date}
         <div>{dname !== '' ? <small className="pull-right badge bg-aqua">{dname} </small>  : null}</div>
          </td>)
