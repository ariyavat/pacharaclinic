...
export default class EmployeeForm extends Component {
  ...
  handleSaveData (e) {
    ...
    } else { show_err('warning','ยังไม่ได้กรอกจำนวนพนักงาน!!!');  }  
            ...
            <form className="form-horizontal">       
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <div className="form-group">          
                      <label  className="col-sm-2 control-label" >จำนวนพนักงาน<span className="text-red">*</span> </label>
                      <div className="col-sm-6">
                        <input type="text" 
