    ...
    render () { 
      ...
      <header className="main-header">
          ...
          <nav className="navbar navbar-static-top">
              ...
              <h3 className="pull-left mgt-10 mgl-10">{item.data.location_name}</h3>

              <div className="navbar-custom-menu">
                

                <ul className="nav navbar-nav">               
                  <AccountMenu data={item.data} onLogout={this.handleLogout.bind(this)}  onProfile={this.handleProfile.bind(this)} />   
                </ul>
              </div>
          </nav>
        </header> 
