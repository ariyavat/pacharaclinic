...
const initialState = {
  id: '', name: '', taxno: '', address: '', tel: '', fax: '', status: 'Y',
};

export default class SuplierForm extends Component {
              ...
              <div className="row">
                <div className="col-sm-6">
                   <h3 className="modal-title text-blue">
                    {
                     this.props.isEdit ? "แก้ไขข้อมูลผู้ขาย / เจ้าหนี้" : "เพิ่มผู้ขาย / เจ้าหนี้"
                    } 
                  </h3>
                </div>
                <div className="col-sm-6">
          ...
          <div className="box-body min-600"> 
                  ...
                  <div className="row">
                    ...
                    <form className="form-horizontal">
                      ...
                      <div className="form-group">                 
                        <label  className="col-sm-3 control-label" >เลขผู้เสียภาษี </label>
                        <div className="col-sm-4">                  
                          <input 
                            type="text"  className="form-control" name="fname" ref='taxno'  
                            value={item.taxno}
                      ...
                      <div className="form-group">          
                        ...
                        <div className="col-sm-9">
                          <input type="text"  className="form-control" name="address" ref='fname'  
                            value={item.name}
                      ...
                      <div className="form-group"> 
                        ...
                        <div className="col-sm-6">                  
                          <input 
                            type="text"  className="form-control" name="fax" ref='tel'  
                            value={item.tel}
