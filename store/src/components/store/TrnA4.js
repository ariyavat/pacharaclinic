...
export default class TrnA4 extends Component {
  constructor(props) {
    super(props);
    ...
    <div className="w-100"> 
    	...
    	<div className="line">				
			...
			<div className="W-50 fl text-center">
				...
				<div className="line mgt-10"><h4>ใบโอนสินค้า</h4></div>
			</div>
				...
				<div className="W-60 fl">
					<div className="border-ttp">				
			        	...
			        	<div className="W-20 fl">
			        		<div className="line">สาขาที่รับ</div>
    	...
    	<div className="line">
	    	<div className="border-header">
		    	...
		    	<tr>
			        <td width="30">#</td>
			        <td width="150" className="text-center">รหัส</td>	       
			        <td className="text-center">รายการ</td>			        
			        <td width="90" className="text-center">จำนวน</td>
			        <td  width="90" className="text-center">หน่วย</td> 
    		...
    		<div className="border-bt">
				<div className="W-50 fl text-center">
					<div className="border-tt">				
						<span className="pull-left">ผู้โอน</span>
