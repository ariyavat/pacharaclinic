...
import BOutForm from '../../components/store/BOutForm';
import ReciveA4 from '../../components/store/ReciveA4';

import {getBOuts, getBOutDetail} from '../../utils/StoreBAPI';
...
export default class BOutPage extends React.Component {
  ...
  render() {
    ...
    <div>
      {
        item.isViews !== 'PRINT' ?
        <ContentHeader title="คลังสินค้า" small="จ่ายออกจากคลัง" >
        {
          item.isViews === 'VIEWS' ?
            ...
            <div className="box-header" >
              ...
              <div className="col-xs-3 col-sm-3">
                <button className="btn btn-flat btn-default pull-right" onClick={this.handleNew.bind(this)} >
                  <i className="fa fa-plus"></i> จ่ายออกจากคลัง
                </button>
