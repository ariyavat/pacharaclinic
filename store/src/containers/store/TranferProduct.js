...
import {getTranfers, getTranfer, getTranfersProduct } from '../../utils/StoreAPI';
...
export default class TranferProduct extends React.Component {
  ...
  render() {
    ...
    <div>
        ...
        <ContentHeader title="โรงงาน" small="สรุปการโอนสินค้าให้สาขา" >
