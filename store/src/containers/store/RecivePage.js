...
import ReciveForm from '../../components/store/ReciveForm';
...
export default class RecivePage extends React.Component {
  ...
  render() {
    ...
    <div>
      {
        item.isViews !== 'PRINT' ?
        <ContentHeader title="คลังวัตถุดิบ" small="รับเข้าคลัง" >
        {
          item.isViews === 'VIEWS' ?
