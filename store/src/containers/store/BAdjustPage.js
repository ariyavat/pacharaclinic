...
import BAdjForm from '../../components/store/BAdjForm';
import ReciveA4 from '../../components/store/ReciveA4';

import {getBAdjusts, getBAdjustDetail} from '../../utils/StoreBAPI';
...
export default class BAdjustPage extends React.Component {
  ...
  render() {
    ...
    <div>
      {
        item.isViews !== 'PRINT' ?
        <ContentHeader title="คลังสินค้า" small="ปรับสต็อค" >
        {
          item.isViews === 'VIEWS' ?
            ...
            <div className="box-header" >
              ...
              <div className="col-xs-3 col-sm-3">
                <button className="btn btn-flat btn-default pull-right" onClick={this.handleNew.bind(this)} >
                  <i className="fa fa-plus"></i> ปรับสต็อค
                </button>
